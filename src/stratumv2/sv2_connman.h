...
struct Sv2Client
{
    ...
    std::deque<node::Sv2NetMsg> m_send_messages;
...
private:
     ...
     */
    std::vector<node::Sv2NetMsg> ReadAndDecryptSv2NetMsgs(Sv2Client& client, bsv::span<std::byte> buffer);
