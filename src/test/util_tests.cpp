...
BOOST_AUTO_TEST_CASE(util_FormatMoney) {
    ...
    // v2.6.1: TBC 货币单位是 TBCCOIN=1e6 sat（不是 BSV COIN=1e8 sat）
    BOOST_CHECK_EQUAL(FormatMoney(123456789 * (TBCCOIN / 10000)), "12345.6789");
    BOOST_CHECK_EQUAL(FormatMoney(-1 * TBCCOIN), "-1.00");

    BOOST_CHECK_EQUAL(FormatMoney(100000000 * TBCCOIN), "100000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(10000000 * TBCCOIN), "10000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(1000000 * TBCCOIN), "1000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(100000 * TBCCOIN), "100000.00");
    BOOST_CHECK_EQUAL(FormatMoney(10000 * TBCCOIN), "10000.00");
    BOOST_CHECK_EQUAL(FormatMoney(1000 * TBCCOIN), "1000.00");
    BOOST_CHECK_EQUAL(FormatMoney(100 * TBCCOIN), "100.00");
    BOOST_CHECK_EQUAL(FormatMoney(10 * TBCCOIN), "10.00");
    BOOST_CHECK_EQUAL(FormatMoney(TBCCOIN), "1.00");
    BOOST_CHECK_EQUAL(FormatMoney(TBCCOIN / 10), "0.10");
    BOOST_CHECK_EQUAL(FormatMoney(TBCCOIN / 100), "0.01");
    BOOST_CHECK_EQUAL(FormatMoney(TBCCOIN / 1000), "0.001");
    BOOST_CHECK_EQUAL(FormatMoney(TBCCOIN / 10000), "0.0001");
    BOOST_CHECK_EQUAL(FormatMoney(TBCCOIN / 100000), "0.00001");
    BOOST_CHECK_EQUAL(FormatMoney(TBCCOIN / 1000000), "0.000001");
}
...
BOOST_AUTO_TEST_CASE(util_ParseMoney) {
    ...
    // v2.6.1: TBC 货币单位是 TBCCOIN=1e6 sat
    BOOST_CHECK(ParseMoney("12345.6789", ret));
    BOOST_CHECK_EQUAL(ret, 123456789 * (TBCCOIN / 10000));

    BOOST_CHECK(ParseMoney("100000000.00", ret));
    BOOST_CHECK_EQUAL(ret, 100000000 * TBCCOIN);
    BOOST_CHECK(ParseMoney("10000000.00", ret));
    BOOST_CHECK_EQUAL(ret, 10000000 * TBCCOIN);
    BOOST_CHECK(ParseMoney("1000000.00", ret));
    BOOST_CHECK_EQUAL(ret, 1000000 * TBCCOIN);
    BOOST_CHECK(ParseMoney("100000.00", ret));
    BOOST_CHECK_EQUAL(ret, 100000 * TBCCOIN);
    BOOST_CHECK(ParseMoney("10000.00", ret));
    BOOST_CHECK_EQUAL(ret, 10000 * TBCCOIN);
    BOOST_CHECK(ParseMoney("1000.00", ret));
    BOOST_CHECK_EQUAL(ret, 1000 * TBCCOIN);
    BOOST_CHECK(ParseMoney("100.00", ret));
    BOOST_CHECK_EQUAL(ret, 100 * TBCCOIN);
    BOOST_CHECK(ParseMoney("10.00", ret));
    BOOST_CHECK_EQUAL(ret, 10 * TBCCOIN);
    BOOST_CHECK(ParseMoney("1.00", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN);
    BOOST_CHECK(ParseMoney("1", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN);
    BOOST_CHECK(ParseMoney("0.1", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN / 10);
    BOOST_CHECK(ParseMoney("0.01", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN / 100);
    BOOST_CHECK(ParseMoney("0.001", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN / 1000);
    BOOST_CHECK(ParseMoney("0.0001", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN / 10000);
    BOOST_CHECK(ParseMoney("0.00001", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN / 100000);
    BOOST_CHECK(ParseMoney("0.000001", ret));
    BOOST_CHECK_EQUAL(ret, TBCCOIN / 1000000);
