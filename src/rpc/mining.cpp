...
static UniValue getmininginfo(const Config &config,
    ...
    if (request.fHelp || request.params.size() != 0) {
        throw std::runtime_error(
            ...
            "  \"currentblocksize\": nnn,   (numeric) The serialized size of "
            "the last assembled block template\n"
            "  \"currentblocktx\": nnn,     (numeric) The number of "
            "non-coinbase transactions in the last assembled block template\n"
